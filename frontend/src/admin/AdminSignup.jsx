...
function AdminSignup() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#a6300d] to-[#ffff7d]">
      <div className="h-auto container mx-auto flex  items-center justify-center text-white">
        {/* Header */}
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20">
          <h2 className="text-2xl font-bold mb-4 text-center">
            Welcome to <span className="text-orange-500">Online Course Hub</span>
          </h2>
